...
var sms_pop = new Audio('/soud/sms_pop.mp3');
        ...
        if(exists)
        {
            if(OpenedChatRef == refcmsg)
            {
                ...
                snap.forEach(element => {
                    ...
                    msgtocant = '';
                    if(us == Userid){
                        msgtocant = `<div class="ca-send"><div class="ca-send__msg-group"><div class="ca-send__msgwrapper"><div class="ca-send__msg">${msg}</div></div><div class="metadata"><span class="time">10:10 AM</span><span class="tick"><img src="/messenger/images/tick/tick-read.svg" alt=""></span></div></div></div>`;
                    }else{
